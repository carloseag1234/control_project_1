///Motor en encoder controller Code
...
/*----Global Variables----*/
  ...
  const double kp = 1.06506;        //Proportional Constant
  const double ki = 0.33944;        //Integrative  Constant
  const double kd =  -0.074;        //Derivative Constant
